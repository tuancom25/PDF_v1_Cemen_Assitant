 # ============================================================
#  this file name to run  :: python -m app.services.p_main_2 
# p_main_0.py
#
# MAIN PIPELINE
#
...
# 6. IMPORT CHUNKING
# ============================================================
from app.services.chunking.chunk import ( Chunk, Chunker,  )
...
def main():
    ...
    for document_index, pdf in enumerate(
        ...
        # pdf_files : là list tên cá file pdf , hoặc  tên các thư mục, nằm trong app/data/processed/documents 
        # ====================================================
      ...
      #  document = (   document_loader   .load_document(pdf)   )
        ...
        for document in list_of_documents:
            ...
            for document_details in path_of_document_page.glob("*.json"):
               ...
               # page = loader.load_page(     document_details # manifest              )
                page = loader.load_page(document_details)
            ...
            for page_index, page in enumerate(
                ...
                unassigned_groups = (  unassigned_builder  .build(
                        content_blocks,
                        groups
                    )
                )
