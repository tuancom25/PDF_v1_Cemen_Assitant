 # ============================================================
# this file name to run  :: python -m app.services.p_main_5 
# p_main_5.py
# version 5.0 này và các version trước đang bị  thừa 1 vòng lặp for document in list_of_documents:  , vì đã có vòng for document_index, pdf in enumerate(pdf_files):  rồi.
# phiên bản này đang chunking theo ,  groupSimantic 
#( cần thêm môt phiên bản - chunking theo page cũng được . )
# Giữ lại 1 bản chunking theo page . 
# MAIN PIPELINE
#
# PDF
#   ↓
